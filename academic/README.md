...
Three interconnected educational offerings that bridge multi-agent systems theory, gamification science, and hands-on implementation.
...
| 3. Control Theory | Feedback systems, PID | Metrics, engagement analytics |
| 4. Bandit Algorithms | UCB, Thompson Sampling, regret | Reward schedules, A/B testing |
| 5. Contextual & Bayesian | Contextual bandits, BO | Personalization, adaptive systems |
| 6. AI Agents & Ensembles | Multi-agent coordination, LLMs | Behavioral adaptation |
| 7. Safety & Ethics | Alignment, guardrails, mechanism design | Dark patterns, ethical design |
| 8. Competition Day | Evaluation, statistical testing | Experiment analysis, presentation |

## Flexible Entry Points

Not everyone takes both courses. The workshop accommodates three profiles:
